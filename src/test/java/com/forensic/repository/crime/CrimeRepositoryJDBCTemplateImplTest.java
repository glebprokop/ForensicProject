...
public class CrimeRepositoryJDBCTemplateImplTest {
    ...
    public void info(){
        testCrime = Crime.builder()
                ...
                .caseInvestigationNumber(010101L)
        ...
        repository = context.getBean("crimeRepositoryJDBCTemplateImpl", CrimeRepository.class);
    }
